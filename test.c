...
*/
    ...
    status=1;
    DEBUG_LIST_PRINT("master_key",KARACELL_MASTER_KEY_U32_COUNT_MAX,(u8 *)(master_key_base),2);
...
*/
      ...
      entropy_spawn_status=0;
      DEBUG_LIST_PRINT("entropy_list",KARACELL_MASTER_KEY_U32_COUNT_MAX,(u8 *)(entropy_list_base),2);
/*
...
*/
    ...
    DEBUG_LIST_PRINT("iv",KARACELL_IV_U32_COUNT,(u8 *)(iv_base),2);
    if(!decrypt_status){
