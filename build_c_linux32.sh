...
gcc -D_32_ -D_FILE_OFFSET_BITS=64 -DDEBUG_OFF -DPTHREAD -DPIPELINE_OFF -O3 -pthread -fno-stack-protector -mtune=native temp/jytter.o temp/timestamp.o -otemp/karacell main.c
