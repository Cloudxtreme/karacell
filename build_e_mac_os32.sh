...
clang -D_32_ -D_FILE_OFFSET_BITS=64 -DDEBUG_OFF -DPTHREAD -DPIPELINE_OFF -Wall -Wextra -Wconstant-conversion -Wint-conversion -Wconversion -O3 -pthread -fno-stack-protector -m32 temp/jytter.o temp/timestamp.o -o temp/karacell main.c
