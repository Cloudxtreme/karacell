...
clang -D_64_ -DDEBUG_OFF -DPTHREAD -DPIPELINE_OFF -Wall -Wextra -Wconstant-conversion -Wint-conversion -Wconversion -O3 -pthread -fno-stack-protector -m64 temp/jytter.o temp/timestamp.o -o temp/karacell os.c
